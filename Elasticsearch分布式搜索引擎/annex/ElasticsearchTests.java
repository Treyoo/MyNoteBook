...
public class ElasticsearchTests {
    ...
    public void testInsert() {
        discussRepository.save(discussMapper.selectDiscussPostById(241));//一次插入一条数据
    ...
    public void testInsertList() {
        discussRepository.saveAll(discussMapper.selectDiscussPosts(101, 0, 100, 0));//一次插入多条数据
    ...
    public void testSearchByRepository() {
        SearchQuery searchQuery = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.multiMatchQuery("改革春风吹满地", "title", "content"))
